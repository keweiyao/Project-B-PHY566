...
These models can be used to describe systems out of the eco-system context. For example, in economics, they are used to predict demand supply models, etc. They are also used in fields of public health or to model virus-cell interactions or 
